...
from app.models.app import Message, NewPassword, Token, UserPublic
...
async def recover_password(email: str, session: SessionDep) -> Message:
    ...
    Password Recovery
    """
    user = await app.get_user_by_email(session=session, email=email)
